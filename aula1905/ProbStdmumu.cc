...
char AEDLFILE[] = "DUNE_GLoBES.glb"; //arquivo AEDL que caracteriza o experimento-> dune
...
int main(int argc, char * argv[])
{
	...
	outstd_mu_mu.open("probability_DUNE_mu_mu.dat"); //nome do arquivo que vai armazenar os dados
	...
	{
	  glbSetOscillationParameters(true_values);
	  prob_mu_mu=glbVacuumProbability(2,2,+1,energy,L); // calcula prob de mu->mu (e=1,mu=2,tau=3)
